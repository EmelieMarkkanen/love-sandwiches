...
SHEET = GSPREAD_CLIENT.open('p2_love_sandwiches')
...
def get_last_5_entries_sale():
    """
    Collect collumns if data from sales worksheet, 
    collecting the last 5 entries for ech sandwich and return the data as
    a list of lists
    """
